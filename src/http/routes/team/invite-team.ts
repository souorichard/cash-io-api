  ...
  app.withTypeProvider<ZodTypeProvider>().post(
    ...
    async (request) => {
      ...
      const data = await resend.emails.send({
        from: `Equipe Cash.io <${process.env.EMAIL_SENDER}>`,
        to: [email],
        subject: `Voce foi convidado para o entrar na equipe do(a) ${owner}`,
        html: `
          <div style="font-family: Arial, sans-serif; text-align: center; line-height: 1.6">
            <div style="max-width: 460px; margin: 0 auto; padding: 20px">
              ...
              <p style="color: rgb(113 113 122); font-size: 16px; margin-bottom: 24px">
                Você foi convidado(a) para participar de uma equipe. Para confirmar sua participação, clique no link abaixo: 
              </p>
